                    ...
                    <div class="col">
                        <div class="card h-100 shadow border-0">
                            ...
                            <div class="card-body">
                                ...
                                {card.technology.map(tech => (<button className="btn btn-warning rounded-0 m-1">{tech}</button>))}
                            </div>
                            <div class="card-footer border-0 bg-transparent">
                                <a href={card.liveSite} target="_blank" rel="noreferrer">
                                    <button className="btn btn-success rounded-0 m-1">Live Site</button>
                                </a>
                                <a href={card.code} target="_blank" rel="noreferrer">
                                    <button className="btn btn-success rounded-0 m-1">Code</button>
                                </a>
                            </div>
                        </div>
                    </div>
